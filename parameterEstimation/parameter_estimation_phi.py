...
class parameter_estimation_phi:
    ...
    def custom_gradient_phi(self, *args):
        ...
        for t in range(0, self.I):
            ...
            res = minimize(self.func_phi, x0=gamma_phi, args=args, method = 'SLSQP',jac= self.grad_phi, constraints=cons, options={'maxiter' : 1, 'eps' : 1.0})
